...
public class ReadService extends AbstractPostProcessor<ReaderBO> {
    ...
    public String reader(UserInfo userInfo, String textId) {
        ...
        log.info("bizId: {}, bizName: {} - 分支流程[前置扩展]逻辑开始执行！",
                readerContext.getBizId(), readerContext.getBizName());
        boolean isContinue = postProcessorContainer.doHandleBefore(readerContext, PostProcessorContainer.AND_MODEL);
