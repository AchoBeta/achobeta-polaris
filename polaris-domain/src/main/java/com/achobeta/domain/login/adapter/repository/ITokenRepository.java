...
public interface ITokenRepository {
     ...
     * @param devicId 设备id
     */
    void storeAccessToken(String token, String userId, String phone, String devicId);
     ...
     */
    void storeReflashToken(String token, String userId, String phone, String devicId, Boolean isAutoLogin);
